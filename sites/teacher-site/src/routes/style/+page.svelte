...
<div class="styleguide-container">
  <header class="sg-control-panel">
    <div>
      ...
      <p class="subtitle">Validating runtime token interpolation and layout contracts</p>
    </div>
  ...
  <section class="sg-section">
    ...
    <div class="sg-grid typography-showcase">
      ...
      <div class="sg-card layout-flow">
        <p class="larger-text">This is larger paragraph text styled with <code>.larger-text</code> using Inter or Poppins.</p>
        <p>This is basic body paragraph styling. It automatically leverages your anti-aliasing optimizations. Inside it, you can view an <a href="#links">inline text hyperlink</a> demonstrating automatic high-contrast print transitions.</p>
        
        <details>
          <summary>Details Accordion Summary Element</summary>
          <p>Collapsible block text content including <strong>strongly emphasized brand-highlighted callouts</strong>.</p>
        </details>
      </div>
    </div>
  </section>
  ...
  <section class="sg-section">
    ...
    <p class="section-desc">These chips track shifts dynamically between the Student and Teacher palettes.</p>
