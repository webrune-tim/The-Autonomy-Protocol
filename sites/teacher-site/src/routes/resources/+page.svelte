...
<section class="angled-top-bottom-box thick-margins" style="--color: var(--brand-teal)">
	<h2>Twelve Steps</h2>
	<p>
  ...
  <section class="angled-top-box thick-margins no-bottom-margin" style="--color: var(--brand-orange)">
